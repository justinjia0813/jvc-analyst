...
`ba515d9d0a0810f6f32180980244c74f5eb2a9b96a1499204c2daaeab86af091`
...
| Packaged-script network | pass | deal-flow controller、research core、review-kit renderer、research-report renderer、IC memo validator 和 IC memo package check 均无网络能力；report 只内嵌本地 `data:` URI |
| Permission approvals | pass | 本地 file read、file write、subprocess 已按范围批准 |
| Dependency review | warn | research core 和 IC memo validator/package check 仅使用 Python 标准库，report Python 依赖已锁定；既有 DOCX/发票依赖仍有未固定版本项 |
